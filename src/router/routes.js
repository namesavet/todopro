...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'Createaccount5', name: 'Createaccount5', component: () => import('pages/Createaccount5.vue') },
      { path: 'Createaccount6', name: 'Createaccount6', component: () => import('pages/Createaccount6.vue') },
